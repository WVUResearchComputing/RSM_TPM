...
def regression_model(base_folder):
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_H_matern2.pkl', 'wb') as file_GP_reg_H_matern2:
        pickle.dump(gp_H_matern2, file_GP_reg_H_matern2)     
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_He_matern2.pkl', 'wb') as file_GP_reg_He_matern2:
        pickle.dump(gp_He_matern2, file_GP_reg_He_matern2)    
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_N_matern2.pkl', 'wb') as file_GP_reg_N_matern2:
        pickle.dump(gp_N_matern2, file_GP_reg_N_matern2)     
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_N2_matern2.pkl', 'wb') as file_GP_reg_N2_matern2:
        pickle.dump(gp_N2_matern2, file_GP_reg_N2_matern2) 
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_O_matern2.pkl', 'wb') as file_GP_reg_O_matern2:
        pickle.dump(gp_O_matern2, file_GP_reg_O_matern2)      
    ...
    with open(base_folder+os.sep+'Outputs/RSM_Regression_Models/'+RSMNAME+'_GP_reg_O2_matern2.pkl', 'wb') as file_GP_reg_O2_matern2:
        pickle.dump(gp_O2_matern2, file_GP_reg_O2_matern2)
